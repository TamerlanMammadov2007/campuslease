...
export function MapView() {
  ...
  // Default view: left sidebar + listing cards
  return (
      ...
      <div className="flex gap-6">
        ...
        <div className="hidden w-72 flex-shrink-0 space-y-4 lg:block">
          ...
          <div className="relative">
            <MapComponent height="h-48" />
            <button
              onClick={() => setShowFullMap(true)}
              className="absolute inset-0 flex items-center justify-center rounded-2xl bg-slate-900/40 transition hover:bg-slate-900/50"
            >
          ...
          <Card className="border border-white/10 bg-white/5">
            <CardContent className="space-y-4">
              ...
              <div>
                <label className="mb-1 block text-xs text-slate-400">Type of Housing</label>
                <div className="space-y-1.5">
                  {propertyTypes.map((type) => (
                    <label key={type} className="flex cursor-pointer items-center gap-2 text-sm text-slate-200">
                      <input
                        type="checkbox"
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <select
                    className="h-9 w-full rounded-xl border border-white/15 bg-white/10 px-2 text-sm text-white"
              ...
              <div className="space-y-1.5">
                {[
                  ...
                  { label: "Pet Friendly", key: "pets" as const },
                  { label: "Parking Available", key: "parking" as const },
                ].map(({ label, key }) => (
