...
const defaultProfile: RoommateProfile = {
  ...
  moveInDate: "",
  preferredLocations: [],
  sleepSchedule: "Flexible" as RoommateProfile["sleepSchedule"],
  cleanliness: "Moderately Clean" as RoommateProfile["cleanliness"],
  noise: "Moderate" as RoommateProfile["noise"],
  guests: "Sometimes" as RoommateProfile["guests"],
  smoking: "No" as RoommateProfile["smoking"],
  drinking: "Sometimes" as RoommateProfile["drinking"],
  pets: "No Pets" as RoommateProfile["pets"],
  studyHabits: "Balanced" as RoommateProfile["studyHabits"],
  socialLevel: "Social" as RoommateProfile["socialLevel"],
  interests: [],
}
